...
export const ShortAnswerCard: React.FC<ShortAnswerCardProps> = ({
  question,
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Fire auto-save after 1.5s of inactivity
    ...
    <BentoCard className="w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
        ...
        <input
          ...
          required={required}
          className="w-full rounded-xl border border-[#E2E8F0] px-4 py-3 text-sm text-[#0F172A] placeholder-[#0F172A]/40 bg-white focus:outline-none focus:ring-2 focus:ring-[#C99700] focus:border-[#C99700] transition-all"
        />
